...
const APP_START_ADDRESS = 0x10000000
...
const FLAGS_SUGGESTING_FAMILY_ID_PRESENT = 0x00002000
...
for (let pos = 0; pos < buf.length; pos += 256) {
    ...
    bl.writeUInt32LE(FLAGS_SUGGESTING_FAMILY_ID_PRESENT, 8) // flags
    ...
    bl.writeUInt32LE(RP2040_FAMILY_ID, 28) // reserved
    for (let i = 0; i < 256; ++i)
        bl[i + 32] = buf[pos + i]
